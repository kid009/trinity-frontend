        ...
        <div class="row padd-90">
          ...
          <div class="col-xs-12 col-md-3 col-md-pull-6">
            <div class="right-sidebar">
              <BusinessProductCommunitySideBar />
            </div>
          </div>
          <Contact
            ...
            :bussiness_product_community_link="
              contact.bussiness_product_community_link
            "
...
import BusinessProductCommunitySideBar from "../../../components/Business/BusinessProductCommunity/BusinessProductCommunitySideBar.vue";

import Details from "../../../components/Business/BusinessProductCommunityDetail/Details.vue";
import Contact from "../../../components/Contact.vue";
import Other from "../../../components/Business/BusinessProductCommunityDetail/Other.vue";

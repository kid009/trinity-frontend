        ...
        <div class="row">
          ...
          >
            <a
              class="black-hover"
              :href="
                'innovationprocessdetail?page=1&group=' +
          ...
          >
            <a
              class="black-hover"
              :href="
                'innovationprocessdetail?page=2&group=' +
          ...
          >
            <a
              class="black-hover"
              :href="
                'innovationprocessdetail?page=3&group=' +
          ...
          >
            <a
              class="black-hover"
              :href="
                'innovationprocessdetail?page=4&group=' +
          ...
          >
            <a
              class="black-hover"
              :href="
                'innovationprocessdetail?page=5&group=' +
          ...
          >
            <a
              class="black-hover"
              :href="
                'innovationprocessdetail?page=6&group=' +

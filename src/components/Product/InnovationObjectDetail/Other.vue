        ...
        <div class="row">
          ...
          >
            <a
              class="black-hover"
              :href="
                'innovationobjectdetail?page=1&group=' +
          ...
          >
            <a
              class="black-hover"
              :href="
                'innovationobjectdetail?page=2&group=' +
          ...
          >
            <a
              class="black-hover"
              :href="
                'innovationobjectdetail?page=3&group=' +
          ...
          >
            <a
              class="black-hover"
              :href="
                'innovationobjectdetail?page=4&group=' +
          ...
          >
            <a
              class="black-hover"
              :href="
                'innovationobjectdetail?page=5&group=' +
          ...
          >
            <a
              class="black-hover"
              :href="
                'innovationobjectdetail?page=6&group=' +

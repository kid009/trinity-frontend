    ...
    <div>
      <div class="detail-content color-1">
        ...
        <!-- <hr>
					...
					<p id="text-detail-product-detail" v-html="items.researcher_tourism_product_detail"></p>	
...
export default {
  ...
  setup() {
    ...
    const getData = async () => {
      ...
      linkvdo = responses.data.data[0].researcher_tourism_product_vdo;
      changLinkvdo(linkvdo);

      imgAll.value.push(
        responses.data.data[0].researcher_tourism_product_image_cover_link
      );
    };

  ...
  <div class="col-xs-12 col-sm-8 col-md-9">
    ...
    <div class="grid-content clearfix">
      ...
      <!----------------------- innovation ------------------------------------------------------------->
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-11">
                    <div class="detail-header style-2">
                      ...
                      <div class="" >
                            <div v-if="group == 0 "><h3 class="letter-layout">เทคโนโลยี</h3></div>
                            <div v-if="group ==  1"><h3 class="letter-layout">เทคโนโลยี</h3></div>                          
                            <div class="arrows"> 			   
                            <div class="swiper-container pad-15" data-autoplay="0" data-loop="0" data-speed="1000" data-slides-per-view="responsive" data-mob-slides="1" data-xs-slides="2" data-sm-slides="2" data-md-slides="3" data-lg-slides="3" data-add-slides="3">
                              <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide" v-for="items in innovation"
      ...
      <!----------------------- TourismProduct ------------------------------------------------------------->
            ...
            <div class="">
              <div v-if="group == 0 "><h3 class="letter-layout">นวัตกรรมผลิตภัณฑ์</h3></div>  
              <div v-if="group ==  2"><h3 class="letter-layout">นวัตกรรมผลิตภัณฑ์</h3></div>  
                  <div class="arrows"> 			   
                  <div class="swiper-container pad-15" data-autoplay="0" data-loop="0" data-speed="1000" data-slides-per-view="responsive" data-mob-slides="1" data-xs-slides="2" data-sm-slides="2" data-md-slides="3" data-lg-slides="3" data-add-slides="3">
                    <div class="swiper-wrapper" >

                      <div class="swiper-slide" v-for="item in TourismProduct"
      ...
      <!----------------------- Technology ------------------------------------------------------------->
            ...
            <div class="">
              <div v-if="group == 0 "><h3 class="letter-layout">สินค้าในชุมชน</h3></div>
              <div v-if="group ==  3"><h3 class="letter-layout">สินค้าในชุมชน</h3></div>
                  <div class="arrows"> 			   
                  <div class="swiper-container pad-15" data-autoplay="0" data-loop="0" data-speed="1000" data-slides-per-view="responsive" data-mob-slides="1" data-xs-slides="2" data-sm-slides="2" data-md-slides="3" data-lg-slides="3" data-add-slides="3">
                    <div class="swiper-wrapper">

                      <div class="swiper-slide" v-for="item in Technology"
      ...
      <!--------------------------------- Technology -------------------------------------------------->
            ...
            <div class="">
              <div v-if="group == 0 "><h3 class="letter-layout">ผลิตภัณฑ์ธุรกิจ</h3></div>
              <div v-if="group == 4"><h3 class="letter-layout">ผลิตภัณฑ์ธุรกิจ</h3></div>
                  <div class="arrows"> 			   
                  <div class="swiper-container pad-15" data-autoplay="0" data-loop="0" data-speed="1000" data-slides-per-view="responsive" data-mob-slides="1" data-xs-slides="2" data-sm-slides="2" data-md-slides="3" data-lg-slides="3" data-add-slides="3">
                    <div class="swiper-wrapper">

                      <div class="swiper-slide" v-for="item in ProductCommunity"
      ...
      <!--------------------------------- ProductCommunity -------------------------------------------------->
            ...
            <div class="">
               <div v-if="group == 0 "><h3 class="letter-layout">ผลิตภัณฑ์ท่องเที่ยว</h3></div>
                <div v-if="group ==  5"><h3 class="letter-layout">ผลิตภัณฑ์ท่องเที่ยว</h3></div>
                  <div class="arrows"> 			   
                  <div class="swiper-container pad-15" data-autoplay="0" data-loop="0" data-speed="1000" data-slides-per-view="responsive" data-mob-slides="1" data-xs-slides="2" data-sm-slides="2" data-md-slides="3" data-lg-slides="3" data-add-slides="3">
                    <div class="swiper-wrapper">

                      <div class="swiper-slide" v-for="item in businessProduct"
      ...
      <!--------------------------------- businessProduct -------------------------------------------------->
            ...
            <div class="">
              <div v-if="group == 0 "><h3 class="letter-layout">ผลิตภัณฑ์ชุมชน</h3></div>
             <div v-if="group ==  6"><h3 class="letter-layout">ผลิตภัณฑ์ชุมชน</h3></div>
                  <div class="arrows"> 			   
                  <div class="swiper-container pad-15" data-autoplay="0" data-loop="0" data-speed="1000" data-slides-per-view="responsive" data-mob-slides="1" data-xs-slides="2" data-sm-slides="2" data-md-slides="3" data-lg-slides="3" data-add-slides="3">
                    <div class="swiper-wrapper">

                      <div class="swiper-slide" v-for="item in Product"

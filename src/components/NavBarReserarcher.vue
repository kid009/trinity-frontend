          ...
          <div class="col-md-12">
            ...
            <div class="nav">
              ...
              <nav class="menu">
                <ul>
                  <li class="type-1">
                    <a href="/" class="color-dark-2 link-blue">
                      หน้าแรก<span></span>
                    </a>
                  </li>
                  <li class="type-1">
                    ...
                    <ul class="dropmenu">
                      ...
                      <li class="type-1">
                        ...
                        <ul class="dropmenu">
                          ...
                          <li class="type-1">
                            <router-link
                              to="researcherproductpage?page=1&group=0&id=0"
                              class="color-dark-2 link-blue"
                            >
                              นวัตกรรมท่องเที่ยว<span></span>
                            </router-link>
                          </li>
                        </ul>
                      </li>
                    ...
                    <ul class="dropmenu">
                      <li>
                        <router-link
                          ...
                          class="color-dark-2 link-blue"
                        >
                          ความรู้งานวิจัย/โครงการ<span></span>
                        </router-link>
                      </li>
                      <li>
                        <router-link

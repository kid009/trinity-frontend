                ...
                <ul>
                  ...
                  <li class="type-1">
                    <a class="color-dark-2 link-blue"
                      >เทคโนโลยีและนวัตกรรม<span class="fa fa-angle-down"></span
                    ></a>
                    <ul class="dropmenu">
                      <li>
                        <router-link to="technologypage?page=1&group=0&id=0">
                          เทคโนโลยี<span></span>
                        </router-link>
                      </li>
                      <li class="type-1">
                        <a class="color-dark-2 link-blue"
                          >นวัตกรรม<span class="fa fa-angle-down"></span
                        ></a>
                        <ul class="dropmenu">
                          <li>
                            <router-link
                            ...
                            >
                              นวัตกรรมสิ่งประดิษฐ์<span></span>
                            </router-link>
                          </li>
                          <li>
                            <router-link
                  ...
                  <li class="type-1">
                    ...
                    <ul class="dropmenu">
                      <li>
                        ...
                        >
                          ความรู้จากงานวิจัย/โครงการ<span></span>
                        </router-link>
                      </li>
                      <li>
                        <router-link to="communitylearnning">
                          ความรู้เกี่ยวกับCBT<span></span>
                        </router-link>
                      </li>
                      <li>
                        <router-link to="communitycasestudy">

    ...
    <div>
      <div class="detail-content color-1">
        ...
        <div class="detail-content-block clearfix">
          <a target="_blank" v-bind:href="items.bussiness_service_link">
...
export default {
  ...
  setup() {
    ...
    const getData = async () => {
      ...
      BusinessServiceDetail.value = response.data.data;
      linkvdo = response.data.data[0].bussiness_service_vdo;
      changLinkvdo(linkvdo);

      imgAll.value.push(
        response.data.data[0].bussiness_service_image_cover_link
      );
    };

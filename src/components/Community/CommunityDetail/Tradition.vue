  ...
  <div class="">
    ...
    <!-- <div class="main-wraper">
      <div class="container bg_tab">
        <div class="row">
          <div class="col-md-12">
            <h2 class="text-h2 text-letter">
              กิจกรรมประเพณี ตามฤดูกาลต่างๆของชุมชน
            </h2>
          </div>
        </div>
                ...
                >
                  <div class="offers-block radius-mask">
                    <div class="clip">
                      <div class="bg bg-bg-chrome act">
                        ...
                        <div class="price price-s-1">
                          เริ่มวันที่ {{ items.tradition_start_date }}
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="vertical-bottom">
                      <h3 class="text-letter">{{ items.tradition_name }}</h3>
                      <hr />
                      <p></p>

                      <a
                        :href="
                          'CommunityPageDetail?page=tradition&traditionid=' +
                          items.tradition_id +
                          '&id=' +
                          items.community_id
                        "
    ...
    <div class="grid-content clearfix bg_tab">
      <!--------------------------- product -------------------------------------------------------->
      <div>
        <div class="container box">
          <div class="row" id="style-1">
            <h3 class="text-h2 text-letter">
              กิจกรรมประเพณี ตามฤดูกาลต่างๆของชุมชน
            </h3>
            <div class="scrollbar">
              <div

    ...
    <div>
      <div class="detail-content color-1">
        ...
        <div class="detail-content-block clearfix">
          <a target="_blank" v-bind:href="items.bussiness_knowhow_link">
...
export default {
  ...
  setup() {
    ...
    const getData = async () => {
      ...
      imgAll.value.push(
        responses.data.data[0].bussiness_knowhow_image_cover_link
      );

      linkvdo = responses.data.data[0].bussiness_knowhow_vdo;

    ...
    <div>
      <div class="detail-content color-1">
        ...
        <!-- <hr>
					...
					<p id="text-detail-product-detail" v-html="items.researcher_knowhow_detail"></p>	
        ...
        <div class="detail-content-block clearfix">
          <a target="_blank" v-bind:href="items.researcher_knowhow_link">
...
export default {
  ...
  setup() {
    ...
    const getData = async () => {
      ...
      linkvdo = responses.data.data[0].researcher_knowhow_vdo;
      changLinkvdo(linkvdo);
      imgAll.value.push(
        responses.data.data[0].researcher_knowhow_image_cover_link
      );
    };

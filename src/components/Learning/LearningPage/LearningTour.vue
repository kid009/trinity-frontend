              ...
              <div class="community">
                <div class="hotel-items">
                  <img
                    ...
                    v-lazy="'images/learnmore/3.png'"
                    alt=""
                  />
                  <div class="inner_position_top_bottom">
                    <h2 class="shadow">นักท่องเที่ยว</h2>
                  </div>
                </div>
              </div>
            </router-link>
            ...
            <div class="link-to">
              <div class="container box">
                <div class="row">
                  <div class="col-md-4">
                    <a @click="changeTab(1)"
                      ><h3 class="text_color_nav">
                        นวัตกรรมท่องเที่ยวโดยชุมชน
                      </h3>
                    </a>
                  ...
                  <div class="col-md-4">
                    <a @click="changeTab(2)"
                      ><h3 class="text_color_nav">ชุมชนท่องเที่ยว</h3>
                    </a>
                    <div class="vl"></div>
                  </div>
                  <!-- <div class="col-md-2">
                    <a href="#"
                      ><h3 class="text_color_nav">ข้อควรปฏิบัติ</h3>
                    </a>
                    <div class="vl"></div>
                  </div> -->
                  <div class="col-md-4">
                    <a @click="changeTab(3)"
                      ><h3 class="text_color_nav">วางแผนการท่องเที่ยว</h3>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="col-md-12">
                  ...
                  <div v-show="Tab == 2"><TabAll :community="community" /></div>
                  <div v-show="Tab == 3"><TabPlantrip /></div>
                </div>
              </div>
            </div>
          </div>
...
import TabPlantrip from "../LearningPage/LearnningDetail/DetailTap/TabPlantrip.vue";

import TabAll from "../LearningPage/LearnningDetail/DetailTap/TabAll.vue";
export default {
  name: "LearningTour",
  components: { TabPlantrip, TabAll },
  setup() {
    const Tab = ref("1");

    ...
    <div class="col-xs-12 col-md-12">
      <div class="isotope-container row row10">
        <div
          ...
          v-for="item in innovationobject.slice(0, 9)"
          v-bind:key="item.researcher_innovation_id"
        >
          <a
            @click="
              on_click(
          ...
          >
            <div class="block_grids">
              ...
              <!-- <div class="inner_position_bottom_bottom">
                <h3 class="">
                  {{ item.researcher_innovation_name.substring(0, 50) }}
                </h3>
              </div> -->
...
export default {
  ...
  setup() {
    ...
    const getData = async () => {
      ...
      innovationobject.value = response.data.data;
    };

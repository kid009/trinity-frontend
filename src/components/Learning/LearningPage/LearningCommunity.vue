              ...
              <div class="community">
                <div class="hotel-items">
                  <img
                    ...
                    v-lazy="'images/learnmore/2.png'"
                    alt=""
                  />
                  <div class="inner_position_top_bottom">
                    <h2 class="shadow">ชุมชน</h2>
                  </div>
                </div>
              </div>
            </router-link>
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <a href="#" @click="changeTab(3)"
                      ><h3 class="text_color_nav">เครือข่าย</h3>
                    </a>
                    <!-- <div class="vl"></div> -->
                  </div>
                  <div class="col-md-3">
            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="col-md-12">
                  ...
                  <div v-show="Tab == 3"><TabPartner /></div>
                </div>
              </div>
            </div>
          </div>
...
import TabPartner from "../LearningPage/LearnningDetail/DetailTap/TabPartner.vue";

import TabAll from "../LearningPage/LearnningDetail/DetailTap/TabAll.vue";
export default {
  name: "LearningCommunity",
  components: { TabPartner, TabAll },
  setup() {
    const Tab = ref("1");

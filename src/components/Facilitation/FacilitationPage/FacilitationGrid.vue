<template>
  <div class="grid-content clearfix">
    ...
    <!--------------------------------- homestay -------------------------------------------->
    <div v-else-if="page == 'homestay'">
      <div class="container box">
        <div class="row" id="style-1">
          <div v-if="group == 0">
            <h3 class="letter-layout">รีสอร์ท</h3>
          </div>
          <div class="scrollbar">
            <div
              class="list-item-entry"
    ...
    <!--------------------------------- restaurant -------------------------------------------->
    <div v-else-if="page == 'restaurant'">
      <div class="container box">
        <div class="row" id="style-1">
          <div v-if="group == 0">
            <h3 class="letter-layout">ร้านอาหาร</h3>
          </div>
          <div class="scrollbar">
            <div
              class="list-item-entry"
    ...
    <!--------------------------------- poi -------------------------------------------->
    <div v-else-if="page == 'poi'">
      <div class="container box">
        <div class="row" id="style-1">
          <div v-if="group == 0">
            <h3 class="letter-layout">สถานที่บริการ</h3>
          </div>
          <div class="scrollbar">
            <div
              class="list-item-entry"
              v-for="items in poi"
              v-bind:key="items.poi_id"
            >
              <div class="hotel-item style-10 bg-white">
                <div class="table-view">
                  <a @click="on_click('poi', items.poi_id)">
                    <div class="radius-top">
                      <img
                        id="img-travel"
                        :src="items.poi_image_cover"
                        alt=""
                      />
                    </div>
                    <div class="title">
                      <h4>{{ items.poi_name }}</h4>
                    </div>
                  </a>
                </div>
              </div>
  ...
  setup() {
    ...
    const getData = async () => {
      const response = await axios.get(
        `${BASE_API_URL}/accommodation/convenienceAll?page=` +
          page +
          "&group=" +
          group +
          "&id=" +
      ...
      hotel.value = response.data.data_hotel;
      homestay.value = response.data.data_homestay;
      restaurant.value = response.data.data_restaurant;
      poi.value = response.data.data_poi;
    };

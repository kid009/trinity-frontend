          ...
          <div class="">
            ...
            <div class="col-md-3">
              <div class="clearfix">
                ...
                <div class="drop-wrap drop-wrap-s-3">
                  <input v-model="budget" placeholder="ค่าใช้จ่าย/Cost" />
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    setupLeafletMap: function (newVal) {
                ...
                `            <div style="width: 200px; height: 300px;">
                            <b>ชุมชน</b>: ${community_name}
                                    ...
                                    <a href="communitydetail?id=${community_id}">
                                     <img style="width: 170px; height: 150px; display: block;margin: auto;" src='${activity_image_cover_link}' >
                                     </a>
                                     <br/>
                                    <b>กิจกรรม</b>: ${activity_name}
                                    <br/>
                                    <a class='c-button bg-green '   href="activitydetailall?page=1&group=2&id=${activity_id} ")' >เพิ่มเติม</a>
                                     <button  class='c-button bg-green hv-transparent fr'   onclick='addActivity(${province_id},${community_id},${activity_id},"${community_name}","${activity_name}","${activity_image_cover_link}")' >เลือก</button>
                                    <br/>
                                     <br/>
                                     <br/>
                                     </div>
      ...
      // console.log(line._selectedRoute);

      //////////////////////////////////////////////
      //     line.on("routeselected", function (e) {
      //       var route = e.route;
      ...
      //         `<div id="container">
      //   <div id="content">
      //    <div class="details-text">Distance : <b>` +
      //         distance +
      //         ` Km</b></div>
      //    <div class="details-text">Temps estimé: <b>` +
      //         time +
      //         ` Min</b></div>
      // </div>`;
              ...
              L.marker([hotel_latitude, hotel_longitude], {
                ...
                `<div style="width: 200px; height: 300px;">
                        <b>ชื่อที่พัก</b> ${hotel_name}
                                    ...
                                    <br/>
                                     <a href="communitydetail?id=${community_id}">
                                    <img style="width: 170px; height: 150px; display: block;margin: auto;" src="${hotel_image_cover_link}" alt="">
                                    </a>

                                    <br/>
                                    <a class='c-button bg-green '   href="facilitationdetailindexpage?page=hotel&group=0&id=${hotel_id} ")' >เพิ่มเติม</a>
                                     <button  class='c-button bg-green hv-transparent fr'   onclick='addHotel("${province_name}",${community_id},${hotel_id},"${hotel_name}","${hotel_image_cover_link}")' >เลือก</button>
                                    <br/>
                                     <br/>
                                     <br/>
                               </div>
              ...
              L.marker([homestay_latitude, homestay_longitude], {
                ...
                `<div style="width: 200px; height: 300px;">
                            <b>ชื่อที่พัก</b> ${homestay_name}
                                    ...
                                    <br/>
                                     <a href="communitydetail?id=${community_id}">
                                    <img style="width: 170px; height: 150px; display: block;margin: auto;" src="${homestay_image_cover_link}" alt="">
                                     </a>

                                    <br/>
                                    <a class='c-button bg-green '   href="facilitationdetailindexpage?page=homestay&group=0&id=${homestay_id} ")' >เพิ่มเติม</a>

                                     <button  class='c-button bg-green hv-transparent fr'   onclick='addHomestay("${province_name}",${community_id},${homestay_id},"${homestay_name}","${homestay_image_cover_link}")' >เลือก</button>
                                    <br/>
                                     <br/>
                                     <br/>
                               </div>
              ...
              L.marker([restaurant_latitude, restaurant_longitude], {
                ...
                `<div style="width: 200px; height: 300px;">
                          <b>ชื่อร้านอาหาร</b> ${restaurant_name}
                                    ...
                                    <br/>
                                     <a href="communitydetail?id=${community_id}">
                                    <img style="width: 170px; height: 150px; display: block;margin: auto;" src="${restaurant_image_cover_link}" alt="">
                                    </a>
                                    <br/>
                                    <a class='c-button bg-green '   href="facilitationdetailindexpage?page=restaurant&group=0&id=${restaurant_id} ")' >เพิ่มเติม</a>
                                     <button  class='c-button bg-green hv-transparent fr'   onclick='addRestaurant(${province_id},${community_id},${restaurant_id},"${restaurant_name}","${restaurant_image_cover_link}")' >เลือก</button>
                                    <br/>
                                     <br/>
                                     <br/>
                               </div>
              ...
              L.marker([bussiness_latitude, bussiness_longitude], {
                ...
                `<div style="width: 200px; height: 300px;">
                          <b>ชื่อธุรกิจ</b> ${bussiness_name}
                                    ...
                                    <br/>
                                    <a class='c-button bg-green hv-transparent fr'   href="facilitationdetailindexpage?page=bussiness&group=0&id=${bussiness_id} ")' >เพิ่มเติม</a>
                                     <br/>
              ...
              L.marker([nature_latitude, nature_longitude], {
                ...
                `<div style="width: 200px; height: 300px;">
                            <b>ชื่อ</b> ${nature_name}
                                    ...
                                    <img style="width: 170px; height: 150px; display: block;margin: auto;" src="${nature_image_cover_link}" alt="">
                                    </a>
                                     <br/>
                                    <a class='c-button bg-green hv-transparent fr'   href="facilitationdetailindexpage?page=nature&group=0&id=${nature_id}" >เพิ่มเติม</a>
              ...
              L.marker([place_latitude, place_longitude], {
                ...
                `<div style="width: 200px; height: 300px;">
                            <b>ชื่อ</b> ${place_name}
                                    ...
                                    <img style="width: 170px; height: 150px; display: block;margin: auto;" src="${place_image_cover_link}" alt="">
                                    </a>
                                     <br/>
                                    <a class='c-button bg-green hv-transparent fr'   href="facilitationdetailindexpage?page=place&group=0&id=${place_id}" >เพิ่มเติม</a>
